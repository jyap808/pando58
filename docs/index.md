...
![Pando58](assets/images/pando58_hero.jpg)
...
Pando58 came about through wanting a flat PCB version of my [hand-wired Cosmos Dactyl](https://julianyap.com/posts/2025-11-16-1763340628/). The key layout was inspired by the [Kinesis Advantage2](https://kinesis-ergo.com/keyboards/advantage2-keyboard/#layout) with a simplified thumb cluster.
...
<img src="assets/images/pando_logo_256.png" alt="Alt text" style="display: block; margin: 0 auto;">
...
Visit the [Build](build.md) page to learn about the build process.
